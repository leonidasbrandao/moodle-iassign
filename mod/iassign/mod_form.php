...
class mod_iassign_mod_form extends moodleform_mod {
    ...
    function definition() {
        ...
        $this->add_intro_editor(true, get_string('description', 'iassign'));
        ...
        //$mform->setExpanded('general_fields');
        ...
        $grade_group=array();
        $grade_group[] =& $mform->createElement('modgrade', 'grade', '');
        $mform->setDefault('grade', 100);
        if($course_modules_id != 0)
        	$grade_group[] =& $mform->createElement('advcheckbox', 'grade_enabled', '', get_string('enable'));
        $mform->addGroup($grade_group, 'grade_group', get_string('grade', 'iassign'), ' ', false);
        if($course_modules_id != 0)
        	$mform->disabledIf('grade_group', 'grade_enabled');
        ...
        if($course_modules_id != 0) {
	        ...
	        if ($iassign_statement) {
	        	...
	        	//$mform->setExpanded('header_general_fields_apply');
        ...
        $this->add_action_buttons(true, get_string('write_iassign_form', 'iassign'));
    }
