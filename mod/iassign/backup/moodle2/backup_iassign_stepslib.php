...
class backup_iassign_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $iassign = new backup_nested_element('iassign', array('id'),
                        array('name',
                              'course',
                        	  'intro',
                        	  'introformat',	
        ...
        $statement = new backup_nested_element('statement', array('id'),
                        array('name',
                            'iassignid',
                            'type_iassign',
                            'proposition',
        ...
        $iassign_submission = new backup_nested_element('iassign_submission', array('id'),
                        array('iassign_statementid',
                            'userid',
                            'timecreated',
                            'timemodified',
                            'grade',
        ...
        $iassign_submission_comment = new backup_nested_element('iassign_submission_comment', array('id'),
                        array('iassign_submissionid',
                            'comment_authorid',
                            'timecreated',
                            'comment',
                            'return_status',
