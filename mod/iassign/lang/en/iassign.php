...
$string['data_ilm']='Information iLM';
...
$string['error_check_iassign_tinymce'] = 'Warning: the iAssign TinyMCE editor button or Atto editor button is not installed, the module iAssign not function correctly.';
...
$string['write_form'] = 'Save';
$string['move_iassign'] = 'Move to another iLM activities';
$string['question_move_iassign'] = 'Do move the activities selected for the iLM?';
$string['select_move_iassign'] = 'Select the iLM to move the activities';
$string['error_ilm_not_selected_to_move'] = 'ERROR: select a iLM to move the activities!';
$string['choose_type_param'] = 'type';
$string['param_type_static'] = 'static';
$string['param_type_static_help'] = 'Enter the <p> fixed value that will always be displayed with this applet </p>.';
$string['param_type_value'] = 'value';
$string['param_type_value_help'] = '<p> Enter the pattern that appears to the teacher in creating an activity value </p>.';
$string['param_type_boolean'] = 'true / false';
$string['param_type_boolean_help'] = '<p> Choose the default value (True / False) that will appear to the teacher in creating an activity </p>.';
$string['param_type_choice'] = 'Select';
$string['param_type_choice_help'] = '<p> Enter the values ​​that will be displayed to choose a teacher in creating an activity </p> <i>. Note: Enter each value on a new line < / i> </p> ';
$string['param_type_multiple'] = 'Multiple Choice';
$string['param_type_multiple_help'] = '<p> Enter the values ​​that are displayed for the teacher to choose one or more options in creating an activity </p> <i>. Note: Enter each value in a new line </ i> </p> ';
$string['type_param'] = 'Types of Parameters of Applets';
$string['type_param_help'] = '<p> Static </p> This type is fixed and always will be inserted in all uses of this applet. </p> Value </p> In this type the professsor can enter any value to create an activity with this applet. </p> True / False </p> In this type the teacher may choose between true or false to create an activity with this applet. </p> Choose </p> In this type the teacher may choose from several pre-defined values ​​when creating an activity with this applet. </p> Multipla Choose </p> <p> this type the teacher may choose one or more values ​​from several predefined values ​​when creating an activity with this applet </p> .';
$string['name_param'] = 'Parameter Name';
$string['name_param_help'] = '<p> Enter the parameter name, and this name will be inserted into the applet tag </p>. Important: do not insert special characters and spaces, as these will be removed to save the parameter </p> .';
$string['config_param_description_help'] = '<p> This description will appear in the form of aid for the teacher on the display parameter when creating an activity </p>.';
$string['write_iassign_form'] = 'Save and display';
$string['param_header'] = 'Module Parameters';
$string['param_header_help'] = '<p> module parameters are settings to customize the module according to the activities. </p> To learn more about each parameter, see the help for each. </p> ';
$string['param_default'] = 'Default';
$string['param_default_static'] = 'Note:. To change this value please contact the administrator';
$string['export_update_ilm'] = 'Export iLM for update online';
$string['error_ilm_path'] = 'ERROR: iLM folder was not found to perform the installation, no iLM was inserted!';
$string['error_ilm_delete'] = 'ERROR: Could not delete the iLM and its contents.';
$string['messageprovider: activity'] = 'Notification of inclusion / modification of an activity iAssign';
$string['messageprovider: submission'] = 'Notification of dispatch of iAssign';
$string['messageprovider: comment'] = 'Comment Notification of iAssign';
$string['messages'] = 'Posts';
$string['messages_report_group'] = 'Vision Group';
$string['messages_report_table'] = 'Vision Table';
$string['messages_allactivities'] = 'All activities';
$string['messages_alldays'] = 'Everyday';
$string['messages_allusers'] = 'All participants';
$string['messages_allmessages'] = 'All messages';
$string['messages_getthesemessages'] = 'Get these messages';
$string['messages_records'] = 'Displaying records {$a}';
$string['comment_mark_read'] = 'Mark my comments read';
$string['submit_comment_and_mark_read'] = 'Send comments and Mark all as read';
$string['send_message_activity'] = 'New Activity';
$string['send_message_activity_text'] = 'The subject teacher entered / modified activity.';
$string['send_message_submission'] = 'Sending Student:';
$string['send_message_submission_text'] = 'The student \'{$a}\'has submitted a response to the activity.';
$string['send_message_comment'] = 'New Comment';
$string['send_message_comment_text'] = 'The \'{$a}\'sent a comment.';
$string['message_notify_activity'] = 'Notify students by email/popup on the activity?';
$string['message_notify_submission'] = 'Warning by email/popup about sending students?';
$string['message_notify_comment'] = 'Warning by email/popup on comentátios students/teachers?';
$string['repository'] = 'Repository';
$string['license'] = 'license';
$string['license_help'] = 'Enter a license for iLM <br> Types:. BSD, MIT, Apache, GPL 2.0, GPLv3 AGPL, LGPL, Mozilla / EPL, CC v4.0, etc.';
$string['type_license'] = 'type';
$string['author_license'] = 'Author';
$string['error_import_ilm'] = 'ERROR: Unable to import the iLM, the package might be corrupted!';
$string['repository_files'] = 'Files in Repository';
$string['pluginadministration'] = 'iAssign';
$string['comment_unread_legend'] = 'Unread comment';
